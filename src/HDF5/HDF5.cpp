...
void HDF5::open(const char* file_path)
{
...
void HDF5::write_group(const char *name)
{
    hid_t g_id;
...
void HDF5::write(const char *name, int data)
{
...
void HDF5::write(const char *name, double data)
{
...
void HDF5::write(const char *name, char *data)
{
...
void HDF5::write_array(const char *name, int *data, size_t size)
{
    type_id=H5T_NATIVE_INT;
...
void HDF5::write_array(const char *name, double *data, size_t size)
{
    type_id=H5T_NATIVE_DOUBLE;
    create_dataset(name, 1, size);
    status=H5Dwrite(dataset_id, type_id, H5S_ALL, H5S_ALL, H5P_DEFAULT, data);
...
void HDF5::write_array_2d(const char *name, int **data, size_t size1, size_t size2)
{
    int *wdata;
    unreshape_2d(&wdata, data, size1, size2);
    type_id=H5T_NATIVE_INT;
...
void HDF5::write_array_2d(const char *name, double **data, size_t size1, size_t size2)
{
    double *wdata;
    unreshape_2d(&wdata, data, size1, size2);
    type_id=H5T_NATIVE_DOUBLE;
...
void HDF5::write_array_3d(const char *name, int ***data, size_t size1, size_t size2, size_t size3)
{
    int *wdata;
    unreshape_3d(&wdata, data, size1, size2, size3);
    type_id=H5T_NATIVE_INT;
...
void HDF5::write_array_3d(const char *name, double ***data, size_t size1, size_t size2, size_t size3)
{
    double *wdata;
    unreshape_3d(&wdata, data, size1, size2, size3);
    type_id=H5T_NATIVE_DOUBLE;
...
void HDF5::write_hyper_array_3d(const char *name, double ***data, size_t *mem_dims, size_t *mem_offsets, size_t size1, size_t size2, size_t size3)
{
    double *wdata;
    unreshape_3d(&wdata, data, mem_dims[0], mem_dims[1], mem_dims[2]);
    type_id=H5T_NATIVE_DOUBLE;
    create_dataset(name, 3, size1, size2, size3);
...
void HDF5::write_array_4d(const char *name, int ****data, size_t size1, size_t size2, size_t size3, size_t size4)
{
    int *wdata;
    unreshape_4d(&wdata, data, size1, size2, size3, size4);
    type_id=H5T_NATIVE_INT;
...
void HDF5::write_array_4d(const char *name, double ****data, size_t size1, size_t size2, size_t size3, size_t size4)
{
    double *wdata;
    unreshape_4d(&wdata, data, size1, size2, size3, size4);
    type_id=H5T_NATIVE_DOUBLE;
...
void HDF5::write_hyper_array_4d(const char *name, double ****data, size_t *mem_dims, size_t *mem_offsets, size_t size1, size_t size2, size_t size3, size_t size4)
{
    double *wdata;
    unreshape_4d(&wdata, data, mem_dims[0], mem_dims[1], mem_dims[2], mem_dims[3]);
    type_id=H5T_NATIVE_DOUBLE;
    create_dataset(name, 4, size1, size2, size3, size4);
...
void HDF5::read(const char *name, int &data)
{
    hsize_t dims[1]={0};
...
void HDF5::read(const char *name, double &data)
{
    hsize_t dims[1]={0};
    open_dataset(name, dims);
    type_id=H5T_NATIVE_DOUBLE;
...
void HDF5::read(const char *name, char data[])
{
    hsize_t dims[1]={0};
    open_dataset(name, dims);
    type_id=H5Dget_type(dataset_id);
    char *wdata; mallocate(&wdata, HDF5_STRING_LENGTH);
    status=H5Dread(dataset_id, type_id, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata);
    strcpy(data, wdata);
    close_dataset();
}

void HDF5::read_array(const char *name, int **data, size_t &size)
{
    unsigned ndim=1;
    hsize_t dims[1]={0}; 
...
void HDF5::read_array(const char *name, double **data, size_t &size)
{
    unsigned ndim=1;
    hsize_t dims[1]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_2d(const char *name, int ***data, size_t &size1, size_t &size2)
{
    unsigned ndim=2;
    hsize_t dims[2]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_2d(const char *name, double ***data, size_t &size1, size_t &size2)
{
    unsigned ndim=2;
    hsize_t dims[2]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_3d(const char *name, int ****data, size_t &size1, size_t &size2, size_t &size3)
{
    unsigned ndim=3;
    hsize_t dims[3]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_3d(const char *name, double ****data, size_t &size1, size_t &size2, size_t &size3)
{
    unsigned ndim=3;
    hsize_t dims[3]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_4d(const char *name, int *****data, size_t &size1, size_t &size2, size_t &size3, size_t &size4)
{
    unsigned ndim=4;
    hsize_t dims[4]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::read_array_4d(const char *name, double *****data, size_t &size1, size_t &size2, size_t &size3, size_t &size4)
{
    unsigned ndim=4;
    hsize_t dims[4]={0}; 
    open_dataset(name, dims, ndim); 
...
void HDF5::create_dataset(const char *name, size_t ndim, size_t size1, size_t size2, size_t size3, size_t size4)
{
    status=H5Lget_info(f_id, name, NULL, H5P_DEFAULT); 
    if(0==status){
...
void HDF5::open_dataset(const char *name, hsize_t *dims, unsigned ndim)
{
