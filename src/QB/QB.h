...
extern int          QB_read_lmp(QB_tools *QB,const char name[50]);
extern int          QB_read_lmc(QB_tools *QB,const char name[50]);
extern int          QB_read_vasp(QB_tools *QB,const char name[50]);
extern void 		QB_free_exchannel(QB_tools* QB);
#define QB_PI 3.141592653589793
...
extern void 	    QB_rotate(QB_tools *QB,int i,vector center,vector vv, float angle);
extern void 	    QB_mirror(QB_tools *QB,int i,vector p0, double dis);
