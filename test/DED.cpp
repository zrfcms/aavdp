...
void DED::find_first_and_second_knearests()
{
    ...
    while(knearest_2!=nullptr){
        if(knearest_2->Kmagnitude-knearest_1->Kmagnitude>DED_KMAG_LIMIT&&vector_angle(knearest_2->K, knearest_1->K)<=HALF_PI&&vector_angle(knearest_2->K, knearest_1->K)>1.0e-6) break;
